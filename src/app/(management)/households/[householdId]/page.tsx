      ...
      <Panel title="Household actions" eyebrow="Admin">
        <div className="flex flex-wrap items-center justify-between gap-4">
          <p className="max-w-2xl text-sm text-muted">
            Archive this household when it should no longer appear in active workflows. Existing stickers will be
            disabled, while historical interaction events remain available for analytics.
          </p>
