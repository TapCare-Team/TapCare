...
export default async function NewOfficerStickerPage({
  params
}: {
  ...
  return (
    <AppShell
      ...
      nav={[
        { href: `/households/${detail.household.id}/stickers`, label: "Sticker setup", replace: true }
      ]}
    >
      ...
      <StickerSetupManager
        ...
        mode="create"
        afterCreateHref={`/households/${detail.household.id}/stickers`}
      />
    </AppShell>
  );
}
